...
propertyApp.service('localStorageService', ['$http', '$routeParams', function ($http, $routeParams) {
    return {
        ...
        writeFavoriteProperty: writeFavoriteProperty,
    ...
    function getFaves() {
        return "Faves "+ (getLengthLocalStorage()- getCountRequest());
    }
    ...
    function writeFavoriteProperty(propertyId) {
        localStorage.setItem(propertyId, propertyId);
    }

    function removeFavoriteProperty(propertyId) {
